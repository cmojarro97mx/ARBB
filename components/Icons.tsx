...
export const AlaslaLogo: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 160 40" xmlns="http://www.w3.org/2000/svg" {...props}>
        <text x="0" y="30" fontFamily="Arial, Helvetica, sans-serif" fontSize="30" fontWeight="bold" fill="currentColor">
            Alasla
        </text>
    </svg>
);
...
export const UploadCloud: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z" /><polyline points="16 6 12 2 8 6" /><line x1="12" y1="2" x2="12" y2="15" /></svg>
);
...
export const Signature: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M22 10.5c0 .5-.5 1-1 1s-1-.5-1-1 .5-1 1-1c.6 0 1 .5 1 1Z"/><path d="m15 5 2 2"/><path d="M18.8 3.2c1.2-1.2 3.1-.1 2.1 1.2l-3.2 4.4c-.4.5-.6 1.2-.5 1.8s.5 1.1 1 1.4c.5.3 1.1.4 1.7.2s1.1-.6 1.4-1.1l2.5-3.6c1-1.3-.1-3.2-1.2-2.1L18.8 3.2Z"/><path d="M12.5 10.5c-4.6 2.5-6.6 7.5-3.5 10.5s8-1 10.5-3.5c.1-.1.2-.2.2-.3"/><path d="m7 15 2 2"/><path d="M16 12c-2.3 2.3-5.3 3.5-8.5 3.5s-6.2-1.2-8.5-3.5c-2-2-2-5.1 0-7.1l1.5-1.5c1-1 2.2-1.4 3.5-1.4s2.5.5 3.5 1.4L16 12Z"/></svg>
);
...
export const ArrivingCarAnimation: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M14 16.5 V15a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v1.5"/><path d="M10 13V8"/><path d="M2 13h10"/><path d="M5 18h-1.5a1.5 1.5 0 0 1 0-3H5"/><circle cx="17" cy="18" r="2"/></svg>
);
...
export const LightbulbIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M9 18h6"/><path d="M10 22h4"/><path d="M12 2a7 7 0 0 0-4.95 11.95A3.5 3.5 0 0 1 12 22a3.5 3.5 0 0 1 4.95-8.05A7 7 0 0 0 12 2z"/></svg>
);
